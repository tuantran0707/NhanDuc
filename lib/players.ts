...
export const players: Player[] = [
  ...
  { stt: 2, name: "Hoàng Nguyễn", number: 68, position: "HLV", squad: "san11" },
  ...
  { stt: 12, name: "Tony Trần", number: 96, position: "Forwards", squad: "san11" },
  ...
  { stt: 29, name: "Anthony", number: 99, position: "Forwards", squad: "san11" },
  ...
  { stt: 32, name: "Quốc Khánh", number: 28, position: "Forwards", squad: "san11" },
  ...
  { stt: 42, name: "HLV Vũ Nghệ", number: 9, position: "HLV" },
  { stt: 43, name: "Văn Vin", number: 33, position: "GK" },
];
